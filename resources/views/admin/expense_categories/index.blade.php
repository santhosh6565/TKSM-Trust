    ...
    <div class="card p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        <div class="p-4">
            <div class="flex items-center justify-between pt-4">
                <h2 class="lg:text-2xl text-md dark:text-white font-semibold mb-4">Expense Categories</h2>
                <div>
                    ...
                    <div id="categoryModal" 
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-3/4 md:w-96 relative" id="modalContent">
                            ...
                            <h2 class="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-200">Create expense Category</h2>
                            ...
                            <p class="bg-purple-100 border-l-4 border-purple-700 rounded-md p-4 mb-4 text-sm text-gray-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                This expense category is used to organize Expense, making it easier to maintain.
                            </p>
                            
                            <form action="{{ route('admin.expense_categories.create') }}" method="POST">
                                @csrf
                                <div class="mb-4">
        ...
        <div class="pt-4 pb-4">
            <p class="bg-purple-100 border-l-4 border-purple-700 rounded-md p-4 mb-4 text-sm text-gray-700 dark:bg-gray-700 dark:border-purple-600 dark:text-white">
                1. This Expense Category is used to organize the expenses, making it easier to maintain.
            </p>
        </div>
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex items-center justify-center">
                                    <form action="{{ route('admin.expense_categories.show', $category->id) }}" method="GET" class="inline">
                                        <button
                                            type="submit"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="mt-4 mb-6">
                                                ...
                                                <form action="{{ route('admin.expense_categories.update', $category->id) }}" method="POST">
                                                    @csrf
                                                    <input 
                                                        type="text" 
                                                        name="name" 
                                    ...
                                    <form action="{{ route('admin.expense_categories.delete', $category->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this category and its expenses?');">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="submit"
