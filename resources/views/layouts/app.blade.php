...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <title>@yield('title') | Admin Dashboard | Thirukulandhai Sri Mayan Charitable Trust</title>
    ...
    <!-- Primary Meta Tags -->
    <meta name="description" content="Admin dashboard of Thirukulandhai Sri Mayan Charitable Trust. Manage events, donations, user accounts, and more.">
    <meta name="keywords" content="admin dashboard, manage events, manage donations, admin tasks, Thirukulandhai Sri Mayan Charitable Trust admin panel, manage users, admin login">
